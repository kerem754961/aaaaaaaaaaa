function MenuState(name) {
	...
	btns.push(new MenuButton("More Games", 20, _yPos+210, function() {
		window.open("https://www.youtube.com/channel/UC3YWs6tczTMsYeXO4sMvbfA/featured");
	}));
...
function AboutState(name) {
	...
	var text = "skw Tic-tac-toe (or Noughts and crosses, Xs and Os) is a game for two players, X and O, who take turns marking the spaces in a 3×3 grid. The player who succeeds in placing three respective marks in a horizontal, vertical, or diagonal row wins the game.";
	var hastick = false;
